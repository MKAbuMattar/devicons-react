...
const VuestorefrontPlain = (props) => {
  ...
  return createElement(
    ...
    createElement(
      ...
      createElement('path', {
        d:
          'M105.85 8.76c1.41 1.34 1.18 3.14 1.34 4.83-29.2 0-58.4.01-87.6.01.38-1.67-.31-3.69 1.62-4.84h84.64z',
      }),
    ),
  )
}

VuestorefrontPlain.propTypes = {
  color: PropTypes.string,
  size: PropTypes.oneOfType([PropTypes.string, PropTypes.number]),
}

VuestorefrontPlain.defaultProps = {
  color: '#5ECF7B',
  size: '128',
}
