...
const SvgWeblatePlainWordmark = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" {...props}>
    <path
      fill="#2eccaa"
      d="M29.2 72.3c-.7 0-1.3-.1-1.9-.4-1.4-.6-2.6-1.7-3.6-3.3.3-.5.5-1 .8-1.5 1-2.3 1.5-4.8 1.5-7.3v-.3c0-1-.1-2-.5-2.9-.4-1.1-1-2.1-2-2.5-.1-.1-.4-.1-.5-.1-1.2-2.3-1.3-4.5 0-6.6h.1c1.5 0 3 .5 4.3 1.3 3.5 2.2 5.2 6.5 5.2 10.7v.1c-.1 4.5-1.1 9-3.4 12.8zm-7.7 7c-3.2 1.3-7 1.2-10.2-.2C7.6 77.4 4.8 74 3 70.3 0 63.8-.1 56 2.8 49.4c2.1.8 4-.5 4-.5s0 2.1 2 3.1c-2 4.8-2 10.6.1 15.3 1 2.3 2.5 4.4 4.6 5.6.8.4 1.6.7 2.4.8 1.6 2.3 3.5 4.2 5.6 5.6z"
    />
    <path
      fill="#2eccaa"
      d="M29.2 72.3c-.7 0-1.3-.1-1.9-.4-1.4-.6-2.6-1.7-3.6-3.3.3-.5.5-1 .8-1.5.3-.7.6-1.4.8-2.1.5-1.7 6.8.5 5.9 3.2-.6 1.4-1.2 2.8-2 4.1zm-7.7 7c-3.2 1.3-7 1.2-10.2-.2-3.7-1.7.1-7.5 2.2-6.3.8.4 1.6.7 2.4.8 1.6 2.4 3.5 4.3 5.6 5.7z"
      opacity={0.3}
      fillRule="evenodd"
      clipRule="evenodd"
    />
