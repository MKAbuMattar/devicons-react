...
const SvgMoodleOriginal = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" {...props}>
    <radialGradient
      id="moodle-original_svg__a"
      cx={532.855}
      cy={-537.557}
      r={209.76}
    ...
    <path
      fill="url(#moodle-original_svg__a)"
    ...
    <path
      fill="url(#moodle-original_svg__b)"
    ...
    <path
      fill="url(#moodle-original_svg__c)"
    ...
    <path
      fill="url(#moodle-original_svg__d)"
      d="M2.178 47.08c29.932-18.031 46.77-21.43 81.634-25-40.478 31.969-41.499 25-81.634 25"
    />
    <path stroke="#4A4A4C" strokeWidth={0.5} fill="none" d="M83.812 22.246 51.667 45.545" />
    <path opacity={0.23} fill="#231F20" d="M45.545 34.66c.34 3.744-.511-3.572 0 0" />
    <path stroke="#A8ABAD" strokeWidth={0.5} fill="none" d="m2.178 47.08 49.489-1.535" />
    <path
      stroke="#F16922"
      strokeWidth={0.5}
...
export default SvgMoodleOriginal
