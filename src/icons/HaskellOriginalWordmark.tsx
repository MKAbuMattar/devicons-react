...
const SvgHaskellOriginalWordmark = (props: SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg" {...props}>
    ...
    <path fill="#463B63" d="m6.2 71.3 6.2-9.3-6.2-9.3h4.7l12.5 18.7h-4.7l-3.9-5.8-3.9 5.8H6.2z" />
    <path fill="#904F8C" d="m21.3 65.8-2.1-3.1h7.3v3.1h-5.2zm-3.1-4.7L16.1 58h10.4v3.1h-8.3z" />
  </svg>
)

export default SvgHaskellOriginalWordmark
