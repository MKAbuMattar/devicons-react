...
const SvgBootstrapOriginalWordmark = (props: SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg" {...props}>
    <defs>
      <linearGradient
        id="bootstrap-original-wordmark_svg__a"
        x1={76.079}
        x2={523.48}
        y1={10.798}
        y2={365.95}
      ...
      <linearGradient
        id="bootstrap-original-wordmark_svg__b"
        x1={193.51}
        x2={293.51}
        y1={109.74}
        y2={278.87}
      ...
      <filter
        id="bootstrap-original-wordmark_svg__c"
        x={161.9}
        y={135.46}
        width={197}
        height={249}
    ...
    <path
      ...
      fill="url(#bootstrap-original-wordmark_svg__a)"
    />
    <path
      ...
      fill="url(#bootstrap-original-wordmark_svg__b)"
      filter="url(#bootstrap-original-wordmark_svg__c)"
      stroke="#fff"
    />
    <text
      x={9.073}
...
export default SvgBootstrapOriginalWordmark
