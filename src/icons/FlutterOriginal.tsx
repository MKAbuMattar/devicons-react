...
const SvgFlutterOriginal = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" {...props}>
    ...
    <path fill="url(#flutter-original_svg__a)" d="m61.6 113.1 30.8-8.4-10.8-10.8z" />
  </svg>
)

export default SvgFlutterOriginal
