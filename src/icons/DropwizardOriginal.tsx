...
const SvgDropwizardOriginal = (props: SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg" {...props}>
    <defs>
      <linearGradient
        id="dropwizard-original_svg__b"
        x2={1}
      ...
      <clipPath id="dropwizard-original_svg__a">
      ...
      <clipPath id="dropwizard-original_svg__c">
    ...
    <g
      clipPath="url(#dropwizard-original_svg__a)"
      transform="matrix(.03194 0 0 -.03194 26.222 125.997)"
    >
      <path
        fill="url(#dropwizard-original_svg__b)"
    ...
    <g
      clipPath="url(#dropwizard-original_svg__c)"
      transform="matrix(.03194 0 0 -.03194 26.222 125.997)"
    >
      <path
        fill="url(#dropwizard-original_svg__d)"
    ...
    <path
      fill="#f9a72b"
      d="m47.785 97.062 3.237-5.586 3.025 5.884-3.461 7.59-2.801-7.888m26.436-21.14 3.238-5.586 3.025 5.885-3.463 7.589-2.8-7.888m-18.1-22.307 3.238-5.585 3.024 5.885-3.462 7.587-2.8-7.887"
    />
    <path
      fill="#fff200"
      d="m47.785 97.062 3.242-6.541 3.02 6.84-3.456 5.595-2.806-5.894m26.436-21.14 3.244-6.541 3.019 6.84-3.456 5.595-2.806-5.894m-18.1-22.307 3.242-6.54 3.019 6.84-3.457 5.594-2.804-5.894"
    />
    <path
      fill="#24265d"
...
export default SvgDropwizardOriginal
