...
const SvgPowershellOriginal = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" xmlSpace="preserve" viewBox="0 0 128 128" {...props}>
    <linearGradient
      id="powershell-original_svg__a"
      x1={96.306}
      x2={25.454}
      y1={35.144}
      y2={98.431}
    ...
    <path
      fill="url(#powershell-original_svg__a)"
      fillRule="evenodd"
    ...
    <path
      fill="url(#powershell-original_svg__b)"
      fillRule="evenodd"
    ...
    <path
      fill="#2C5591"
      fillRule="evenodd"
      d="M64.2 88.3h22.3c2.6 0 4.7 2.2 4.7 4.9s-2.1 4.9-4.7 4.9H64.2c-2.6 0-4.7-2.2-4.7-4.9s2.1-4.9 4.7-4.9zm14.5-21.8c-.4.8-1.2 1.6-2.6 2.6L34.6 98.9c-2.3 1.6-5.5 1-7.3-1.4-1.7-2.4-1.3-5.7.9-7.3l37.4-27.1v-.6l-23.5-25c-1.9-2-1.7-5.3.4-7.4 2.2-2 5.5-2 7.4 0l28.2 30c1.7 1.9 1.8 4.5.6 6.4z"
      clipRule="evenodd"
    />
    <path
      fill="#FFF"
...
export default SvgPowershellOriginal
