...
const SvgDartPlainWordmark = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" {...props}>
    ...
    <path
      fill="#00a8e1"
      d="M27.2 56.6c-.7-.7-1.9-1.4-3.1-1.7l5.8 16.4-1.7 3.9.4.4 3.9-1.3V61.9l-5.3-5.3zM5.7 70.3V56.2L.3 64.4c-.5.6-.3 1.8.6 2.7L4.6 71l1.2.4c-.1-.4-.1-.7-.1-1.1zm17.5 7.8-.3-.1-15.7-5.6c.4 1 .9 2.1 1.6 2.7l5.5 5.4h12.2l1.4-4.6-4.7 2.2z"
    />
  </svg>
)

export default SvgDartPlainWordmark
