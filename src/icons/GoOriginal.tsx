...
const SvgGoOriginal = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    <defs>
      <path id="go-original_svg__a" d="M18.8 1h90.5v126H18.8z" />
    </defs>
    <clipPath id="go-original_svg__b">
      <use xlinkHref="#go-original_svg__a" overflow="visible" />
    </clipPath>
    <path
      fillRule="evenodd"
      clipRule="evenodd"
      ...
      clipPath="url(#go-original_svg__b)"
    />
    <path
