...
const SvgCloudflareworkersOriginal = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" {...props}>
    <linearGradient
      id="cloudflareworkers-original_svg__a"
      x1={-0.556}
      x2={-0.628}
      y1={128.705}
      y2={128.977}
    ...
    <path
      fill="url(#cloudflareworkers-original_svg__a)"
    ...
    />
    <linearGradient
      id="cloudflareworkers-original_svg__b"
      x1={-0.594}
      x2={-0.715}
      y1={129.358}
      y2={129.519}
    ...
    <path
      fill="url(#cloudflareworkers-original_svg__b)"
    ...
    />
    <linearGradient
      id="cloudflareworkers-original_svg__c"
      x1={-2.234}
      x2={-2.109}
      y1={128.901}
      y2={128.689}
    ...
    <path
      fill="url(#cloudflareworkers-original_svg__c)"
    ...
    />
    <linearGradient
      id="cloudflareworkers-original_svg__d"
      x1={-0.847}
      x2={-0.919}
      y1={128.688}
      y2={128.96}
    ...
    <path
      fill="url(#cloudflareworkers-original_svg__d)"
    ...
    />
    <linearGradient
      id="cloudflareworkers-original_svg__e"
      x1={-2.602}
      x2={-2.229}
      y1={128.679}
      y2={128.977}
    ...
    <path
      fill="url(#cloudflareworkers-original_svg__e)"
    ...
    />
    <linearGradient
      id="cloudflareworkers-original_svg__f"
      x1={-0.561}
      x2={-0.634}
      y1={128.688}
      y2={128.96}
    ...
    <path
      fill="url(#cloudflareworkers-original_svg__f)"
    ...
    />
    <linearGradient
      id="cloudflareworkers-original_svg__g"
      x1={-2.816}
      x2={-2.552}
      y1={128.861}
      y2={128.719}
    ...
    <path
      fill="url(#cloudflareworkers-original_svg__g)"
    ...
    />
    <linearGradient
      id="cloudflareworkers-original_svg__h"
      x1={-2.34}
      x2={-2.001}
      y1={128.779}
      y2={128.952}
    ...
    <path
      fill="url(#cloudflareworkers-original_svg__h)"
...
export default SvgCloudflareworkersOriginal
