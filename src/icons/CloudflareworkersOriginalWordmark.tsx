...
const SvgCloudflareworkersOriginalWordmark = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" {...props}>
    ...
    />
    <linearGradient
      id="cloudflareworkers-original-wordmark_svg__a"
      x1={-0.445}
      x2={-0.477}
      y1={128.845}
      y2={128.968}
    ...
    <path
      fill="url(#cloudflareworkers-original-wordmark_svg__a)"
    ...
    />
    <linearGradient
      id="cloudflareworkers-original-wordmark_svg__b"
      x1={-0.516}
      x2={-0.57}
      y1={129.598}
      y2={129.671}
    ...
    <path
      fill="url(#cloudflareworkers-original-wordmark_svg__b)"
    ...
    />
    <linearGradient
      id="cloudflareworkers-original-wordmark_svg__c"
      x1={-2.013}
      x2={-1.956}
      y1={128.876}
      y2={128.781}
    ...
    <path
      fill="url(#cloudflareworkers-original-wordmark_svg__c)"
    ...
    />
    <linearGradient
      id="cloudflareworkers-original-wordmark_svg__d"
      x1={-0.939}
      x2={-0.972}
      y1={128.83}
      y2={128.953}
    ...
    <path
      fill="url(#cloudflareworkers-original-wordmark_svg__d)"
    ...
    />
    <linearGradient
      id="cloudflareworkers-original-wordmark_svg__e"
      x1={-2.545}
      x2={-2.378}
      y1={128.826}
      y2={128.96}
    ...
    <path
      fill="url(#cloudflareworkers-original-wordmark_svg__e)"
    ...
    />
    <linearGradient
      id="cloudflareworkers-original-wordmark_svg__f"
      x1={-0.572}
      x2={-0.604}
      y1={128.83}
      y2={128.953}
    ...
    <path
      fill="url(#cloudflareworkers-original-wordmark_svg__f)"
    ...
    />
    <linearGradient
      id="cloudflareworkers-original-wordmark_svg__g"
      x1={-2.781}
      x2={-2.663}
      y1={128.908}
      y2={128.844}
    ...
    <path
      fill="url(#cloudflareworkers-original-wordmark_svg__g)"
    ...
    />
    <linearGradient
      id="cloudflareworkers-original-wordmark_svg__h"
      x1={-2.134}
      x2={-1.982}
      y1={128.873}
      y2={128.951}
    ...
    <path
      fill="url(#cloudflareworkers-original-wordmark_svg__h)"
...
export default SvgCloudflareworkersOriginalWordmark
