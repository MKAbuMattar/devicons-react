...
const SvgAzuresqldatabaseOriginal = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" {...props}>
    <defs>
      <radialGradient
        id="azuresqldatabase-original_svg__b"
        cx={9.36}
        cy={10.57}
        fx={9.36}
        fy={10.57}
      ...
      <linearGradient
        id="azuresqldatabase-original_svg__a"
    ...
    <path
      style={{
        stroke: 'none',
        fillRule: 'nonzero',
        fill: 'url(#azuresqldatabase-original_svg__a)',
      }}
    ...
    <path
      style={{
        stroke: 'none',
        fillRule: 'nonzero',
        fill: 'url(#azuresqldatabase-original_svg__b)',
      }}
...
export default SvgAzuresqldatabaseOriginal
