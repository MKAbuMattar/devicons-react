...
const SvgROriginal = (props: SVGProps<SVGSVGElement>) => (
  <svg
  ...
  >
    ...
    <path
      ...
      fill="url(#r-original_svg__b)"
      fillRule="evenodd"
    />
  </svg>
)

export default SvgROriginal
