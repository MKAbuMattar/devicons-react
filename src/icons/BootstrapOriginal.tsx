...
const SvgBootstrapOriginal = (props: SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg" {...props}>
    <defs>
      <linearGradient
        id="bootstrap-original_svg__a"
        x1={76.079}
        x2={523.48}
        y1={10.798}
        y2={365.95}
    ...
    <path
      ...
      fill="url(#bootstrap-original_svg__a)"
    />
    <path
      ...
      fill="url(#bootstrap-original_svg__b)"
      filter="url(#bootstrap-original_svg__c)"
      stroke="#fff"
    />
  </svg>
)

export default SvgBootstrapOriginal
