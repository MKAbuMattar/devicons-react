...
const SvgDartOriginalWordmark = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" {...props}>
    ...
    />
    <path fill="#00c4b3" d="m9.3 56.3-2.2-2.2v16.4c0 .3.1.7.2 1.1l17.3 6.1 4.3-1.9L9.3 56.3z" />
    <path
      d="M7.3 71.7zm21.6 4.2-4.3 1.9-17.3-6.1c.3 1.3 1 2.7 1.8 3.5l5.6 5.6h12.5l1.7-4.9z"
      fill="#22d3c5"
    />
    <path
      fill="#0075c9"
    ...
    />
    <path fill="#0075c9" d="m28.9 75.9 1.9-4.3-6.1-17.3c-.4-.1-.8-.2-1.1-.2H7.1" />
    <path
      d="M24.7 54.3zm4.2 21.6 4.7-1.5V61.5l-5.4-5.4c-.8-.8-2.2-1.5-3.5-1.8l6.1 17.3"
      fill="#00a8e1"
    />
    <path
      fill="#00c4b3"
      d="m23.9 51.9-4-3.9c-.9-.9-2.1-1.2-2.7-.6L7.1 54.1h16.5c.3 0 .7.1 1.1.2l-.8-2.4z"
    />
  </svg>
)

export default SvgDartOriginalWordmark
