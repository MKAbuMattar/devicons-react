...
const SvgAzureOriginal = (props: SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg" {...props}>
    <defs>
      <linearGradient
        id="azure-original_svg__a"
        x1={60.919}
        y1={9.602}
        x2={18.667}
        y2={134.423}
    ...
    <path
      ...
      fill="url(#azure-original_svg__a)"
    ...
    <path
      ...
      fill="url(#azure-original_svg__b)"
      transform="translate(.587 4.468) scale(.91904)"
    />
    <path
      ...
      fill="url(#azure-original_svg__c)"
      transform="translate(.587 4.468) scale(.91904)"
    />
  </svg>
)

export default SvgAzureOriginal
