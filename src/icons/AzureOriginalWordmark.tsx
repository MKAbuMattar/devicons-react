...
const SvgAzureOriginalWordmark = (props: SVGProps<SVGSVGElement>) => (
  <svg viewBox="0 0 128 128" xmlns="http://www.w3.org/2000/svg" {...props}>
    <defs>
      <linearGradient
        id="azure-original-wordmark_svg__a"
        x1={60.919}
        y1={9.602}
        x2={18.667}
        y2={134.423}
      ...
      <linearGradient
        id="azure-original-wordmark_svg__b"
        x1={74.117}
        y1={67.772}
        x2={64.344}
        y2={71.077}
      ...
      <linearGradient
        id="azure-original-wordmark_svg__c"
        x1={68.742}
        y1={5.961}
        x2={115.122}
        y2={129.525}
    ...
    <path
      ...
      fill="url(#azure-original-wordmark_svg__a)"
      transform="translate(2.435 44.576) scale(.29986)"
    />
    <path
      d="M33.983 69.745H14.638a.895.895 0 0 0-.612 1.55l12.431 11.603a1.955 1.955 0 0 0 1.334.525h10.954z"
      fill="#0078d4"
    />
    <path
      d="M46.09.002A6.434 6.434 0 0 0 39.93 4.5L.644 120.897a6.469 6.469 0 0 0 6.106 8.653h32.48a6.941 6.941 0 0 0 5.328-4.531l7.834-23.089 27.985 26.101a6.618 6.618 0 0 0 4.165 1.519h36.396l-15.963-45.616-46.533.011L86.922.002z"
      fill="url(#azure-original-wordmark_svg__b)"
      transform="translate(2.435 44.576) scale(.29986)"
    />
    <path
      ...
      fill="url(#azure-original-wordmark_svg__c)"
      transform="translate(2.435 44.576) scale(.29986)"
    />
  </svg>
)

export default SvgAzureOriginalWordmark
