...
const SvgBitbucketOriginal = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128" {...props}>
    <defs>
      <linearGradient
        id="bitbucket-original_svg__a"
    ...
    <path
      ...
      fill="url(#bitbucket-original_svg__a)"
    />
  </svg>
)

export default SvgBitbucketOriginal
