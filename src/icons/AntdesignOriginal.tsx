...
const SvgAntdesignOriginal = (props: SVGProps<SVGSVGElement>) => (
  <svg xmlns="http://www.w3.org/2000/svg" width={128} height={128} {...props}>
    <defs>
      <linearGradient
        id="antdesign-original_svg__a"
    ...
    <path
      style={{
        stroke: 'none',
        fillRule: 'nonzero',
        fill: 'url(#antdesign-original_svg__a)',
      }}
    ...
    <path
      style={{
        stroke: 'none',
        fillRule: 'nonzero',
        fill: 'url(#antdesign-original_svg__b)',
      }}
    ...
    <path
      style={{
        stroke: 'none',
        fillRule: 'nonzero',
        fill: 'url(#antdesign-original_svg__c)',
      }}
    ...
    <path
      style={{
        stroke: 'none',
        fillRule: 'evenodd',
        fill: 'url(#antdesign-original_svg__d)',
      }}
...
export default SvgAntdesignOriginal
